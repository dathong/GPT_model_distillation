...
def convert_msg_to_prompt(msgs):
    ...
    for msg in msgs:
        if msg['role'] == 'system':
            ...
            new_msg = msg['content'].replace("USER: ","").replace("CUSTOMER: ","")
            return_prompt += "[INST]CUSTOMER: {txt}[/INST]\n\n".format(txt=new_msg)
        elif msg['role'] == 'assistant':
            new_msg = msg['content'].replace("AGENT: ", "").replace("REPRESENTATIVE: ","")
            return_prompt += 'AGENT: ' + new_msg + "\n\n"
